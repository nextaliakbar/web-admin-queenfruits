<div>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa"></i>Edit Produk</h1>
          </div>
          <div class="col-sm-6">
                                      ...
                                      <div class="col-md-4 text-center">
                                          ...
                                          style="cursor: pointer; width: 150px; height: 150px; border-radius: .25rem;">
                                              ...
                                              <div wire:loading.remove wire:target="productImages.0">
                                                ...
                                                @elseif($existingProductImages && isset($existingProductImages[0]))
                                                  <img width="150" height="150" src="{{asset('uploads/' . $existingProductImages[0])}}" alt="Upload Gambar 1">
                                                @else
                                          ...
                                          style="cursor: pointer; width: 150px; height: 150px; border-radius: .25rem;">
                                              ...
                                              <div wire:loading.remove wire:target="productImages.1">
                                                @if($productImages && isset($productImages[1]))
                                                  <img width="150" height="150" src="{{$productImages[1]->temporaryUrl()}}" alt="Upload Gambar 1">
                                                @elseif($existingProductImages && isset($existingProductImages[1]))
                                                  <img width="150" height="150" src="{{asset('uploads/' . $existingProductImages[1])}}" alt="Upload Gambar 1">
                                                @else
                                                  <img width="150" height="150" src="{{ asset('assets/image/add-image.png') }}" alt="Upload Gambar 1">
                                                @endif
                                              </div>
                                          ...
                                          style="cursor: pointer; width: 150px; height: 150px; border-radius: .25rem;">
                                              ...
                                              <div wire:loading.remove wire:target="productImages.2">
                                                @if($productImages && isset($productImages[2]))
                                                  <img width="150" height="150" src="{{$productImages[2]->temporaryUrl()}}" alt="Upload Gambar 1">
                                                @elseif($existingProductImages && isset($existingProductImages[2]))
                                                  <img width="150" height="150" src="{{asset('uploads/' . $existingProductImages[2])}}" alt="Upload Gambar 1">
                                                @else
                                                  <img width="150" height="150" src="{{ asset('assets/image/add-image.png') }}" alt="Upload Gambar 1">
                                                @endif
                                              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="float-right">
                    <button wire:click="resetFields" type="button" class="btn btn-secondary mr-2">
