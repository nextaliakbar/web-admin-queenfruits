  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1><i class="fas fa"></i>Edit Cabang</h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="password" type="password" class="form-control" id="password" placeholder="Masukkan password baru jika ingin memperbaruinya (8+ karakter)">
                            </div>
                            @error('password')
                                <div class="form-group">
                                    <span class="text-danger">{{$message}}</span>
                            ...
                            <div class="form-group">
                                ...
                                <input wire:model="passwordConfirmation" type="password" class="form-control" id="passwordConfirmation" placeholder="8+ karakter">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                style="cursor: pointer; border-radius: .25rem;">
                                    ...
                                    <div wire:loading.remove wire:target="branchImage">
                                        ...
                                        @elseif($existingBranchImage)
                                            <img class="img-fluid rounded" src="{{asset('uploads/' . $existingBranchImage)}}" alt="Gambar Cabang">
                                        @else
